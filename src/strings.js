...
export const t = {
  ...
  repeatAfterDays: 'פעם בכמה ימים (ריק = ללא הגבלה)',
  repeatAfterDaysHelp: 'משימה שאף אחד לא אוהב, כמו מטבח: אותו אדם לא יחזור אליה בתוך מספר הימים הזה כל עוד יש מישהו אחר פנוי. ריק פירושו שאין כלל כזה.',
  cooldownBeyondMemory: (mission, days, memoryDays) => `${mission}: הסבב מוגדר ל־${days} ימים, אבל הסידור זוכר ${memoryDays} ימים בלבד. יש להגדיל את זיכרון הסידור או להקטין את הסבב.`,
